...
parser.add_argument('--datafolder', type=str, default='dataset/pdb2016', help='protein data path')
parser.add_argument('--result_path', type=str,default='result/PDB2016_BENCHMARK',help='path to save results')
...
# best 2016set 
parser.add_argument('--lrate',type=float,default=1e-5) # change to 1e-5 for LargeScaleInteractionDataset
parser.add_argument('--eps',type=float,default=1e-5, help='higher = closer to SGD') # change to 1e-5 for PDBv2016
parser.add_argument('--betas',type=tuple_type, default="(0.9,0.99)")  # change to (0.9,0.99) for PDBv2016

# # # # best 2020set 
# parser.add_argument('--lrate',type=float,default=1e-4) # change to 1e-4 for LargeScaleInteractionDataset
# parser.add_argument('--eps',type=float,default=1e-7, help='higher = closer to SGD') # change to 1e-5 for PDBv2016
...
parser.add_argument('--cfg_file', type=str, default='/data/GRIT-main/configs/GRIT/zinc-GRIT-RRWP.yaml',help='Path to the config file')
