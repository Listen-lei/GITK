...
class net(torch.nn.Module):
    def __init__(self, mol_deg, prot_deg,
        ...
        for idx in range(total_layer):
            ...
            # self.c2a_mlps.append(KAN([hidden_channels, hidden_channels * 2, hidden_channels]))
            # self.c2r_mlps.append(KAN([hidden_channels, hidden_channels * 2, hidden_channels]))
        ...
        # self.mol_out= KAN([hidden_channels, hidden_channels * 2, hidden_channels])
        # self.prot_out = KAN([hidden_channels, hidden_channels * 2, hidden_channels])

        if self.regression_head:
            self.reg_out = MLP([hidden_channels * 2, hidden_channels, 1]) 
            # self.reg_out = KAN([hidden_channels * 2, hidden_channels, 1]) 
